function user_job_setup()
	...
	state.Weapons:options('Learning','AoE','Naegling')
...
function init_gear_sets()
	...
	sets.weapons.AoE = {main="Maxentius",sub="Bunzi's Rod"}
	sets.weapons.Learning = {main="Bronze Sword",sub="Bronze Sword"}
