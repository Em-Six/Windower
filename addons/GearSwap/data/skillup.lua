...
user_settings = {
    user_spells = {
        Healing = T{"Cure","Barfire", "Barwater","Cure"},
        Geomancy = T{},
        Enhancing = T{"Barfire", "Barwater", "Baraero"},
        Ninjutsu = T{},
        Singing = T{"Mage\'s Ballad", "Mage\'s Ballad II", "Advancing March"},
        Blue = T{},
        Summoning = T{}},
    save_settings = false} --change this to true if you wish to save the last position of your skillup window
sets.brd = {
    wind_inst = {
        range="Royal Spearman's Horn"},--put your wind instrument here
    string_inst = {
...
function precast(spell)
    ...
    if spell and (spell.mp_cost - 1) > player.mp  then
