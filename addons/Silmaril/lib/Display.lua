default = {
	...
	info = true,
	display = true,
	Debug_Box = {text={size=10,font='Consolas',red=255,green=255,blue=255,alpha=255},pos={x=1473,y=763},bg={visible=true,red=0,green=0,blue=0,alpha=70},},
	Update_Box = {text={size=10,font='Consolas',red=255,green=255,blue=255,alpha=255},pos={x=1635,y=782},bg={visible=true,red=0,green=0,blue=0,alpha=70},},}
